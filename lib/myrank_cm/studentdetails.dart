...
class CmStudentDetailScreen extends StatefulWidget {
  final int applicationId;
  final String? StudentName;
  final String degree;
  final String courseName;

  const CmStudentDetailScreen({
    Key? key,
  ...
  @override
  State<CmStudentDetailScreen> createState() => _StudentDetailScreenState();
}

class _StudentDetailScreenState extends State<CmStudentDetailScreen> {
  ...
  Future<void> _launchURL(BuildContext context, String url) async {
    if (kIsWeb) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => PdfViewerPage(url: url, color: kPrimaryColor),
        ),
      );
    }
  }
