  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.blue.shade700, // changed from deepPurple
      ),
      body:
          isLoading
...
class StudentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      shadowColor: Colors.blue.shade100, // changed from deepPurple.shade100
      child: Container(
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: Colors.blue.shade900, // changed from deepPurple.shade900
                shadows: [
                  Shadow(
                    color:
                        Colors
                            .blue
                            .shade200, // changed from deepPurple.shade200
                    blurRadius: 2,
            ...
            RichText(
              text: TextSpan(
                style: TextStyle(
                  fontSize: 17,
                  color:
                      Colors.blue.shade800, // changed from deepPurple.shade800
                ),
                children: [
                  const TextSpan(
                    text: 'Highest Degree: ',
