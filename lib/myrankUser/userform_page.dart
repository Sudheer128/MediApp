...
class UserApplicationForm extends StatefulWidget {
  const UserApplicationForm({Key? key}) : super(key: key);

  @override
  State<UserApplicationForm> createState() => _ApplicationFormState();
}

class _ApplicationFormState extends State<UserApplicationForm> {
