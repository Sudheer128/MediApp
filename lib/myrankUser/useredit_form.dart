...
class UserEditApplicationForm extends StatefulWidget {
  ...
  @override
  State<UserEditApplicationForm> createState() => _EditApplicationFormState();
}

class _EditApplicationFormState extends State<UserEditApplicationForm> {
